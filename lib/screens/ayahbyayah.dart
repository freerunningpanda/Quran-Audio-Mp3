...
final ayahByAyahProvider = riverpod.ChangeNotifierProvider.autoDispose
    .family<AyahbyAyahController, int>((_, chapterNo) => AyahbyAyahController(chapterNo));
...
class AyahbyAyahController with ChangeNotifier {
  ...
  generateChaptersText(int surahNo) async {
    ...
    List<List<Ayah>> response = await compute(getTextAndTranslationAyahsBySurahNo, surahNo);
...
class AyahByAyahScreen extends riverpod.ConsumerWidget {
          ...
          body: Scrollbar(
            ...
            child: SingleChildScrollView(
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    TitleWidget(name: aP.surah?.name ?? ''),
                          ...
                          return aP.surahText[index].chapterNo == 1
                              ? VisibilityDetector(
                                  ...
                                  onVisibilityChanged: (VisibilityInfo info) {
                                    aP.updateLastVisibleAyah(aP.surahTranslationText[index]);
                                  },
                                  child: EachAyahWidget(
                                    ...
                                    share: () async {
                                      ...
                                      Navigator.push(context, MaterialPageRoute(builder: (context) {
                                        return StatusMaker(ayahNumber: aP.surahTranslationText[index].number);
                                      }));
                                    },
                                    chapterNo: aP.surah!.number,
                                    arabic: aP.surahText[index].text,
                                    translation: aP.surahTranslationText[index].text,
                                    textDirection: aP.surahTranslationText[index].direction == "ltr"
                                        ? TextDirection.ltr
                                        : TextDirection.rtl,
                                    textDirectionString: aP.surahTranslationText[index].direction,
                                    sajda: aP.surahTranslationText[index].sajda ?? '', //data.data[0][index].sajda,

                                    bookmarked: aP.surahTranslationText[index].bookmarked ?? false,
                                    bookmark: () {
                                      aP.bookmarkAyah(aP.surahTranslationText[index]);
                                    },
                                    isReciting: aP.surahTranslationText[index].number == aP.currentRecitingAyah,
                                    audio: () async {
                                      aP.reciteAyah(context: context, ref: ref, ayah: aP.surahTranslationText[index]);
                                    },
                                  ),
                                )
                              : Column(
                                    ...
                                    aP.surahText[index].chapterNo == 9
                                        ? VisibilityDetector(
                                            ...
                                            child: EachAyahWidget(
                                              ...
                                              share: () async {
                                                ...
                                                Navigator.push(
                                                  ...
                                                  MaterialPageRoute(
                                                    builder: (context) {
                                                      return StatusMaker(
                                                          ayahNumber: aP.surahTranslationText[index].number);
                                                    },
                                                  ),
                                                );
                                              },
                                              ...
                                              isReciting:
                                                  aP.surahTranslationText[index].number == aP.currentRecitingAyah,
                                              audio: () async {
                                                aP.reciteAyah(
                                                    context: context, ref: ref, ayah: aP.surahTranslationText[index]);
                                              },
                                            ),
                                          )
                                        : Align(
                    ...
                    _BottomWidget(scrollController: scrollController, aP: aP)
                  ],
                ),
              ),
            ),
